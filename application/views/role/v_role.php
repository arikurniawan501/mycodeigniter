                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                ...
                                <button class="btn btn-sm bg-secondary" onclick="add_role()"><span class="fa fa-plus"></span> Tambah Data</button>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    function delete_role(id) {
        swal({
            ...
            if (!isConfirm) return;
            $.ajax({
                url: "<?php echo base_url('role/ajax_delete') ?>/" + id,
                type: "post",
                dataType: "JSON",
                success: function(data) {
                    swal({
                ...
                <form action="#" id="form" class="form-horizontal">
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <input name="role" placeholder="Nama Role" class="form-control" type="text">
                        </div>
                    </div>
                </form>
            </div>
