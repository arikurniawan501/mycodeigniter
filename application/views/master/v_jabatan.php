...
<script type="text/javascript">
    ...
    function edit_person(id) {
        ...
        $.ajax({
            url: "<?php echo site_url('master/jabatan/ajax_edit') ?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data) {

                $('[name="id_jabatan"]').val(data.id_jabatan);
                $('[name="n_jabatan"]').val(data.n_jabatan);
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <input name="n_jabatan" placeholder="Nama Jabatan" class="form-control" type="text">
