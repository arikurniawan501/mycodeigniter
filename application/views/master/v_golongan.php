...
<script type="text/javascript">
    ...
    function edit_person(id) {
        ...
        $.ajax({
            url: "<?php echo site_url('master/golongan/ajax_edit') ?>/" + id,
            type: "GET",
            dataType: "JSON",
            success: function(data) {

                $('[name="id_golongan"]').val(data.id_golongan);
                $('[name="n_golongan"]').val(data.n_golongan);
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <input name="n_golongan" placeholder="Nama Golongan" class="form-control" type="text">
